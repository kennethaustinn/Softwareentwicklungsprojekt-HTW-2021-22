...
Installationshinweise :
* Datenbank : Machen Sie ein neu Connection im mysqlworkbench, mit hostname :kompetenzdatenbank.mysql.database.azure.com, username :kompetenzdb@kompetenzdatenbank,  password :Kompetenz2021	
